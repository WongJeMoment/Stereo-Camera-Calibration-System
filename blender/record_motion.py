...
def main(args):
    ...
    meta = {'units': 'meters', 'pose_convention': 'P_opencv_camera = object_to_camera @ P_original_YCB_google16k_OBJ',
            ...
            'render_device': device, 'fps': fps, 'first_frame': start, 'last_frame': end, 'frames_per_camera': end-start+1,
...
<h1>YCB 三相机单物体运动</h1><p>仅一个物体移动和旋转，其余物体保持静止。三路使用相同帧号和时间戳。下面从左到右为左目、右目、侧面全景。</p>
